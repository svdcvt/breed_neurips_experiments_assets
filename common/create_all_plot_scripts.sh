...
common_outdir="\$APEBENCH_ROOT/validation_results_decay/"
...
#OAR -l /nodes=1/core=10,walltime=01:00:00
...
for dir in $subdirs; do
    ...
    for model_id in "${model_ids[@]}"; do
        ...
        echo "$command_prepend python3 \$APEBENCH_ROOT/common/plot_model_predictions.py --study-paths \$APEBENCH_ROOT/$pathhs --model-id $model_id_ --all-plots --output-dir $common_outdir " >> $script_path
        chmod +x $script_path
