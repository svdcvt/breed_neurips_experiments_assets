...
singularity exec  --bind /bettik:/bettik --env APEBENCH_ROOT=/home/dymchens-ext/apebench_test ${singularity_container} melissa-launcher --config_name /home/dymchens-ext/apebench_test/experiments/set/config_offline_diff_ks_cons__2w_x19_easier_max1_1d_x5_mpi.json
sleep 10
singularity exec  --bind /bettik:/bettik --env APEBENCH_ROOT=/home/dymchens-ext/apebench_test ${singularity_container} melissa-launcher --config_name /home/dymchens-ext/apebench_test/experiments/set/config_offline_diff_ks_cons__3w_x09_harder_1d_x5_mpi.json
sleep 10
...
sleep 10
singularity exec  --bind /bettik:/bettik --env APEBENCH_ROOT=/home/dymchens-ext/apebench_test ${singularity_container} melissa-launcher --config_name /home/dymchens-ext/apebench_test/experiments/set/config_offline_diff_kdv__2w_x04_harder_1d_x5_mpi.json
sleep 10
