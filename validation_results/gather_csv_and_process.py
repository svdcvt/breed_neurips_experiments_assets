...
all_csvs = pd.concat([csv for csv in gather_csv_files(f'{REPO_ROOT}/validation_results/validation_results_decay/')], ignore_index=True)
all_csvs.to_csv(f'{REPO_ROOT}/validation_results/validation_results_decay/combined_validation_results.csv', index=False)
